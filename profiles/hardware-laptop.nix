...
# to /etc/nixos/configuration.nix instead.
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/bc96724a-7d34-4856-b61d-f2f9dcf58d93";
    fsType = "btrfs";
    options = ["subvol=root" "compress=zstd" "noatime" "discard=async" "ssd" "space_cache=v2"];
  };

  boot.initrd.luks.devices."enc".device = "/dev/disk/by-uuid/fff590de-437c-4d0f-9dcd-03dd6bf240a6";
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/F694-DAB4";
    fsType = "vfat";
  ...
  swapDevices = [
    {
      device = "/dev/disk/by-partuuid/09338acc-c3b8-4ff2-a9fd-4d8e96cf0031";
